...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    double *mask1, *mask2;
     if(nrhs>=9) {
         mask1 = (double*) oliCheckArg(prhs ,7, Im1.height(), Im1.width(), oliDouble);
         mask2 = (double*) oliCheckArg(prhs ,8, Im2.height(), Im2.width(), oliDouble);
    }
// 	if(nrhs==9)
// 	{
